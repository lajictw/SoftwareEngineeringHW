...
function handleSubmitClick() {
  ...
  uploadBase64Images(base64Images, function () {
    ...
    zxEditor.storage.set('article', data)
    // 发送至服务器
    var $userid=document.getElementById("idholder").innerText;
    post('../../../release.php', {title:data.title,text:data.content,userid:$userid});
    // end
    zxEditor.dialog.removeLoading();
    zxEditor.dialog.alert('作文发布成功!', function () {
      // 文章发布成功
      // 清除本地存储的文章数据
